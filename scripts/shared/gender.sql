...
CREATE TABLE IF NOT EXISTS MOCA.T_SHR_GENDERS(
    gender_id               VARCHAR(32) UNIQUE NOT NULL,
...
INSERT INTO MOCA.T_SHR_GENDERS VALUES ('MALE', 'M', NOW(), NOW(), true);
INSERT INTO MOCA.T_SHR_GENDERS VALUES ('FEMALE', 'F', NOW(), NOW(), true);
