...
CREATE TABLE IF NOT EXISTS MOCA.T_SHR_CITIES(
	city_id						SMALLINT GENERATED BY DEFAULT AS IDENTITY UNIQUE NOT NULL,
	...
	cty_fk_country_id			SMALLINT NOT NULL,
	PRIMARY KEY(city_id)
);
...
ALTER TABLE MOCA.T_SHR_CITIES
	ADD CONSTRAINT FK01_T_SHR_CITIES_TO_COUNTRIES
		FOREIGN KEY(cty_fk_country_id)
		REFERENCES MOCA.T_SHR_COUNTRIES(country_id);

-- --------------------------------------------
-- INSERTS
-- --------------------------------------------

INSERT INTO MOCA.T_SHR_CITIES VALUES (1, 'Ciudad de México', 'CDMX', NOW(), NOW(), true, 484);
INSERT INTO MOCA.T_SHR_CITIES VALUES (2, 'México', 'MX', NOW(), NOW(), true, 484);
INSERT INTO MOCA.T_SHR_CITIES VALUES (3, 'Querétaro', 'QT', NOW(), NOW(), true, 484);
