...
CREATE INDEX I_USER_NID ON T_MOCA_USERS(user_nid);
...
CREATE INDEX I_ACCOUNT_NID ON T_MOCA_ACCOUNTS(account_nid);
...
CREATE INDEX I_ADDRESS_NID ON T_MOCA_ADDRESSES(address_nid);
